...
if __name__ == "__main__": # Corrected line: __name__ with double underscores
    
    cascade_file = "C:\\Users\\laksh\\cv-env\\opencv_workshop\\haarcascade_frontalface_alt.xml"  # Path to the classifier
